    ...
    <div class="info-manage act-online join-sh" style="margin-left:-150px;">
        ...
        <div class="table join-info">
            ...
            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><ul>
                <li><?php echo ($vo["user_name"]); ?><br><a href="<?php echo U('Enter/info',array('id'=>$vo['student_id']));?>">查看</a> </li>
                <li><?php echo ($vo["phone"]); ?></li>
                <li><?php echo ($vo["email"]); ?></li>
                <li><?php echo ($vo["act_name"]); ?></li>
                <?php if($vo["act_status"] == 0): ?><li><img src="/Public/Admin/images/dui.jpg">不需要审核</li>
                <?php else: ?>
                    <li><img src="/Public/Admin/images/dui.jpg" />已处理 </li>
                    <li><img src="/Public/Admin/images/cuo.jpg" />未处理 </li><?php endif; ?>
                <li>
                    <?php if($vo["act_status"] == 0): ?><a href="javascript:;" style="text-align:center;cursor: pointer;color:gray;">是否通过</a>
                    <?php else: ?>
                        <a href="javascript:;" student-id="<?php echo ($vo["student_id"]); ?>" class="pass" style="text-align:center;cursor: pointer;">是否通过</a><?php endif; ?>
                    <?php if($vo["act_status"] == 0): ?><a href="javascript:;">通过</a><?php endif; ?>
