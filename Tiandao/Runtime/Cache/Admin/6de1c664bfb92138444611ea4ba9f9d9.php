    ...
    <div class="info-manage act-online" style="margin-left:-150px;">
        ...
        <div class="table">
            ...
            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><ul class="gray">
                  ...
                  　<?php if(($vo["act_time_status"] == 1) OR ($vo["act_time_status"] == 2)): ?><li><?php echo ($vo["act_start_date"]); ?>-<?php echo ($vo["act_end_date"]); ?></li>
                    <?php else: ?>
                         <li><?php echo ($vo["act_now_date"]); ?></li><?php endif; ?>
                ...
                <ul class="white">
                    <li>
                        ...
                        <!--根据状态显示不同的样式-->
                        <?php if($vo["act_current_status"] == 3): ?><a href="javascript:;" act-id="<?php echo ($vo["act_id"]); ?>" class="sh reback-sh">撤销审核</a><?php endif; ?>
