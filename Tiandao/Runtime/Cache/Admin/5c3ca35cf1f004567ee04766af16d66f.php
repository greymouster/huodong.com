        ...
        <div class="act-info">
            ...
            <form id="myForm" class="base-info" action="" method="POST" enctype="multipart/form-data">
                ...
                <dl>
                    ...
                    <dd><input type="text" name="act_cost"/></dd>
                </dl>
                <dl>
                ...
                <dl>
                    ...
                    <!--更改程序前代码start-->
               <dd><input type="radio" name="act_time_status" value="0" checked="checked" />当天结束</dd>
                    <dd>
                        <input type="radio" name="act_time_status" value="1"/>连续多天
                        <div class="box day">
                            <input type="text" name="start_date" class="datetimepicker-date" placeholder="活动开始日期" />
                            <input type="text" name="start_time" class="datetimepicker-time" placeholder="开始时间" />到
                           <input type="text"  name="end_date"  class="datetimepicker-date" placeholder="活动结束日期" />
                           <input type="text"  name="end_time"  class="datetimepicker-time" placeholder="结束时间" />
                        </div>
                    </dd>
                    <dd>
                        <input type="radio" name="act_time_status" value="2"/>每周举办
                        <div class="box week">
                            <div class="rate">
                                活动频率
                            ...
                            <div class="time">
                                <input type="text" name="act_start_date" class="datetimepicker-date"  placeholder="活动开始日期" />到
                                <input type="text" name="act_end_date" class="datetimepicker-date" placeholder="活动结束日期" />
                                <input type="text" name="act_start_time" class="datetimepicker-time" placeholder="开始时间" />到
		...
		<form id="form1" action="<?php echo U('ReleaseActivity/add');?> " method="POST" enctype="multipart/form-data" >-->
            <div class="base-info overview">
                ...
                <div class="up-pic">
                   ...
                   <p style="text-align: left;">上传尺寸为<span class="big">XX</span>;上传大小为<span class="size">XX<span></p>
                </div>
			...
			<!--<div class="base-info details">-->
                ...
                <!--<textarea id="act_how_part" name="act_how_part"></textarea>-->
<!--&lt;!&ndash;                <button type="button" style="margin-top:20px;" class="submit-file-desc">保存</button>&ndash;&gt;-->
            <!--</div>-->
		</form>
            <div class="bottom">
                <button type="button" class="submit-yulan">预览</button>
                <button type="button" class="submit-caogao">保存</button>
                <button type="button" class="next submit-file-desc" >发布</button>
            </div>
