        ...
        <div class="allTxt1">
            <div class="container no-bottom dIcon dIcons">
                <dl>
                    ...
                    <!--<dd class="dsss">
                        <p class="p_add"><?php echo ($val['act_start_date']); ?>-<?php echo ($val['act_end_date']); ?> 每天 <?php echo ($val['act_start_time']); ?>-<?php echo ($val['act_end_time']); ?></p>
                    </dd>-->
                    <?php if($data["act_time_status"] == 0): ?><dd class="dsss">
                            <p class="p_add"><?php echo ($data["act_start_date"]); ?> <?php echo ($data["act_start_time"]); ?></p>
                        </dd><?php endif; ?>
                    <?php if($data["act_time_status"] == 1): ?><dd class="dsss">
                    ...
                    <?php if($data["act_time_status"] == 2): ?><dd class="dsss">
                ...
                <dl>
                    ...
                    <dd class="dsss">
                        <?php if($val['act_cost'] == 0): ?><p class="lastP p_add"><span class="time">免费</span></p>
                            <?php else: ?>
