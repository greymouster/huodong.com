$(function () {
    ...
    $(".cate-edit").bind('click', function () {
        ...
        layer.prompt({
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        layer.msg('编辑分类成功', {icon: 6,offset:'300px'});
                        setTimeout(function () {
                            window.location.href = window.location.href;
                        }, 1500);
                    }else{
                        layer.alert('编辑分类失败',{icon:5,offset:'300px'});
                    }
                }
            });
        });
    ...
    $(".cate-delete").click(function () {
        ...
        layer.confirm('确认删除？', {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        layer.msg('删除分类成功', {icon: 6,offset:'300px'});
                        setTimeout(function () {
                            window.location.href = window.location.href;
                        }, 1500);
                    }else{
                        layer.alert("删除分类失败",{icon:5,offset:'300px'});
                    }
                }
            });
        }, function (index) {
    ...
    $(".place-add").click(function () {
        layer.prompt({
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        layer.msg('新增地点成功', {icon: 6,offset:'300px'});
                        setTimeout(function () {
                            window.location.href = window.location.href;
                        }, 1500);
                    }else{
                        layer.alert("新增地点失败",{icon:5,offset:'300px'});
                    }
                }
            });
        });
    ...
    $(".place-sort-asc").click(function () {
        ...
        if (prevSortNumber == undefined) {
            layer.alert('排序已经置顶', {icon: 5,offset:'300px'});
            return false;
        }
        $.ajax({
            url: "/index.php/Admin/System/ajaxAsc",
            ...
            success: function (data) {
                if (data.status == 1) {
                    layer.msg('更新排序成功', {icon: 6,offset:'300px'});
                    setTimeout(function () {
                        window.location.href = window.location.href;
                    }, 1500);
                }else{
                    layer.alert("更新排序失败",{icon:5,offset:'300px'});
                }
            }
        });
    });
    ...
    $(".place-sort-desc").bind('click', function () {
        ...
        if (prevSortNumber == undefined) {
            layer.alert('排序已经置底', {icon: 5,offset:'300px'});
            return false;
        }
        $.ajax({
            url: "/index.php/Admin/System/ajaxAsc",
    ...
    $(".place-delete").click(function () {
        ...
        layer.confirm('确认删除？', {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        layer.msg('删除地点成功', {icon: 6,offset:'300px'});
                        setTimeout(function () {
                            window.location.href = window.location.href;
                        }, 1500);
                    }else{
                        layer.alert("删除地点成功",{icon:5,offset:'300px'});
                    }
                }
            });
        }, function (index) {
    ...
    $('.channel-add').click(function () {
        layer.prompt({
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        layer.msg('新增渠道成功', {icon: 6,offset:'300px'});
                        setTimeout(function () {
                            window.location.href = window.location.href;
                        }, 1500);
                    }else{
                        layer.alert("删除渠道失败",{icon:5,offset:'300px'});
                    }
                }
            });
        });
    ...
    $(".channel-delete").click(function () {
        ...
        layer.confirm('确认删除？', {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        layer.msg('删除渠道成功', {icon: 6,offset:'300px'});
                        setTimeout(function () {
                            window.location.href = window.location.href;
                        }, 1500);
                    }else{
    ...
    $('.ad-add').click(function () {
        $('#adForm').ajaxSubmit({
            ...
            success: function (data) {
                if (data.status == 1) {
                    layer.msg(data.info, {icon: 6,offset:'300px'});
                    setTimeout(function () {
                        window.location.href = "/index.php/Admin/Ad/adList";
                    }, 1500);
                }else{
                    layer.alert(data.info, {icon: 5,offset:'300px'});
                }
            }
        });
        return false;
    ...
    $(".act-delete-data").click(function () {
        ...
        layer.confirm('确认删除？', {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        layer.msg(data.info, {icon: 6,offset:'400px'});
                        setTimeout(function () {
                            window.location.href = window.location.href;
                        }, 1500);
                    }else{
                        layer.alert(data.info, {icon: 5,offset:'400px'});
                    }
                }
            });
        }, function (index) {
    ...
    $('.copy-url').click(function () {
        var url = $(this).attr('data-url');
        if (url == "") {
            layer.alert('复制的url为空', {icon: 5,offset:'300px'});
            return false;
        }
    ...
    function copyTextToClipboard(url) {
        ...
        if (document.execCommand('copy')) {
            layer.alert('您复制的url为:<br/>' + url, {icon: 6,offset:'300px'});
        } else {
            layer.alert('复制失败', {icon: 5,offset:'300px'});
        }
    ...
    $('.check-sh').click(function () {
        ...
        layer.confirm('是否审核通过', {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        layer.msg(data.info, {icon: 6,offset:'500px'});
                        setTimeout(function () {
                            window.location.reload();
                        }, 1000);
                    } else {
                        layer.msg(data.info, {icon: 5,offset:'500px'});
                    }
                }
            });
        }, function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == 1) {
                    ...
                    layer.alert(data.info, {icon: 5,offset:'500px'});
                }
            }
        });
    });
    ...
    $('.pass').click(function () {
        ...
        layer.confirm('确定处理吗?', {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        ...
                        layer.msg(data.info, {icon: 5,offset:'400px'});
                    }
                }
            });
            ...
            $.ajax({
                url: '/index.php/Admin/Enter/pass',
                data: {studentId: studentId, pass: 'nopass'},
                type: 'POST',
                dataType: 'json',
                success: function (data) {
                    if (data.status == 1) {
