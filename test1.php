...
<head>
    ...
    <link href="http://cdn.huodongxing.com/Content/v2.0/dist/css/hdx.min.css?v=v3.9.4" rel="stylesheet" type="text/css" />
    ...
    <link href="http://cdn.huodongxing.com/Content/v2.0/dist/css/event-create.min.css?v=v3.9.4" rel="stylesheet" type="text/css" />
...
<input type="hidden" value="2354009652200" id="activity_id" />
<a href="http://www.huodongxing.com/bbx?utm_source=发布活动&utm_medium=&utm_campaign=myevent_create" target="_blank" id="bbx-entry">
    <div style="position:relative;padding-bottom:40px;">
        <img style="position:absolute" src="http://cdn.huodongxing.com/Content/v2.0/img/bbx/entry_myevent_create.jpg" alt="" width="100%">
...
<div class="event-create create-event-container" id="event_main_edit_area">
    ...
    <div class="event-create-body">
        ...
        <form action="/myevent/SaveEvent" class="event-create-form" id="event_base_form" method="post"><input id="Reference" name="Reference" type="hidden" value="" /><input id="Id" name="Id" type="hidden" value="2354009652200" /><input id="Category" name="Category" type="hidden" value="0" />	    <input type="hidden" id="save_event_form_token" name="webTokenValue" value="125AA9A03F3C3B4788FDCC64BDBE8516035A2B06B7DD81116FE60234F88CCB79F35E3ECDE65D51FC60" />
            ...
            <div class="form-group event-create-date">
                ...
                <div class="form-group-date">
                    <input id="Start" name="Start" style="display:none" type="text" value="2016/10/1 17:35:34" />
                    <span class="icon-event-ticket-calendar"></span><input type="text" id="event_start_date" value="2016/10/01" class="form-control"><select id="event_start_time" style="width:165px;height:48px;vertical-align:middle;margin-left:6px;">
                    ...
                    <input id="End" name="End" style="display:none" type="text" value="2016/10/4 1:35:34" />
                    <span class="icon-event-ticket-arrow"></span><div>结束时间：</div><span class="icon-event-ticket-calendar"></span>
                    <input type="text" id="event_end_date" value="2016/10/04" class="form-control"><select id="event_end_time" style="width:165px;height:48px;vertical-align:middle;margin-left:6px;">
                        <option value="00:00" >00:00</option>
                        <option value="00:30" >00:30</option>
                        <option value="01:00" >01:00</option>
                        <option value="01:30" >01:30</option>
            ...
            <div class="form-group" style="margin-bottom:45px;">
                ...
                <div class="event-create-add-category">
                    ...
                    <div class="event-create-add-category-modal hide" id="evt_category_content">
                        <ul>
                            <div id="evt_category"><span class="tag-title">活动类别：<em style="color:Red">*</em></span><li>IT</li><li>互联网</li><li>移动互联网</li><li>电商</li><li>创业</li><li>科技</li><li>投资</li><li>理财</li><li>金融</li><li>营销</li><li>游戏</li><li>亲子</li><li>母婴</li><li>校园</li><li>女性</li><li>公益</li><li>运动</li><li>户外</li><li>旅行</li><li>教育</li><li>手工</li><li>摄影</li><li>文艺</li><li>设计</li><li>读书</li><li>交友</li><li>时尚</li><li>广告</li><li>媒体</li><li>职场</li><li>电影</li><li>音乐</li><li>心理</li><li>健康</li><li style="margin-right: 510px;">演出</li></div>
                            <div id="evt_form"><span class="tag-title">活动形式：<em style="color:Red">*</em></span><li>会议</li><li>展览</li><li>论坛</li><li>课程</li><li>讲座</li><li>沙龙</li><li>聚会</li><li>市集</li><li>派对</li><li>赛事</li><li>分享会</li><li>公开课</li><li>音乐节</li><li>音乐会</li><li>演唱会</li><li>舞台剧</li><li>首映会</li><li>开幕式</li><li>发布会</li></div>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <form action="/file/UploadActivityLogo" enctype="multipart/form-data" id="event_file_upload_form" method="post" style="display:none">		<input type="hidden" name="activityId"  value="2354009652200"/>
        ...
        function submitLogoData(dataUrl,callback) {
            $.ajax({
                ...
                data: { "activityId": 2354009652200, "logoData": dataUrl },
                beforeSend:function(){
    ...
    <form action="/myevent/SaveEventTagPage" class="form-horizontal" id="event_tagpage_form" method="post" style="display:none;">	<input type="hidden" name="SN" id="event_tag_page_sn" value="-1" />
        <input type="hidden" name="activityId" value="2354009652200" />
    ...
    <script type="text/javascript">
        ...
        function autoSaveEventDescription() {
            ...
            $.ajax({
                ...
                data: { "id": 2354009652200, "description": descData },
                success: function(data) {
                    if(data != null && data.AjaxErrStatus != null && data.AjaxErrStatus == 1){
    ...
    <div class="event-create-body hide">
        ...
        <div class="aside" id="edit_template_tools" style="max-width:205px;">
            ...
            <div class="event-create-sign-form-usual clearfix">
                ...
                </ul><ul>                            <li><button type="button" class="btn" onclick="javascript:addEventFormCommonItem(7);;return false;"><span class="icon-btn-age"></span><span>年龄</span></button></li>
    ...
    <script type="text/javascript">
        var formCommonItems = [{"Key":"I_-1","Sort":-1,"Type":"input","Category":"FIELD_COMPANY","IsDefault":false,"Required":false,"Multiple":false,"Title":"公司","Subitems":[],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"单行文本框"},{"Key":"I_-1","Sort":-1,"Type":"input","Category":"FIELD_DEPARTMENT","IsDefault":false,"Required":false,"Multiple":false,"Title":"部门","Subitems":[],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"单行文本框"},{"Key":"I_-1","Sort":-1,"Type":"input","Category":"FIELD_OFFICE","IsDefault":false,"Required":false,"Multiple":false,"Title":"职位","Subitems":[],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"单行文本框"},{"Key":"I_0","Sort":0,"Type":"checkbox","Category":"FIELD_HOBBY","IsDefault":false,"Required":false,"Multiple":false,"Title":"兴趣爱好","Subitems":["文艺","音乐","运动","数码","购物","读书","旅游","时尚","其他"],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"多选按钮框"},{"Key":"I_0","Sort":0,"Type":"radio","Category":"FIELD_BLOOD","IsDefault":false,"Required":false,"Multiple":false,"Title":"血型","Subitems":["A型","B型","O型","AB型"],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"单选按钮框"},{"Key":"I_0","Sort":0,"Type":"radio","Category":"FIELD_MARRIAGE","IsDefault":false,"Required":false,"Multiple":false,"Title":"婚姻状况","Subitems":["未婚","已婚","保密"],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"单选按钮框"},{"Key":"I_-1","Sort":-1,"Type":"radio","Category":"FIELD_GENDER","IsDefault":false,"Required":false,"Multiple":false,"Title":"性别","Subitems":["男","女"],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"单选按钮框"},{"Key":"I_0","Sort":0,"Type":"radio","Category":"FIELD_AGE_RANGE","IsDefault":false,"Required":false,"Multiple":false,"Title":"年龄","Subitems":["15以下","16~20岁","21~25岁","26~30岁","31~40岁","40岁以上"],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"单选按钮框"},{"Key":"I_0","Sort":0,"Type":"radio","Category":"FIELD_EDUCATION","IsDefault":false,"Required":false,"Multiple":false,"Title":"学历","Subitems":["小学","中学","大专","本科","研究生以上"],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"单选按钮框"},{"Key":"I_0","Sort":0,"Type":"select","Category":"FIELD_RESIDENCE","IsDefault":false,"Required":false,"Multiple":false,"Title":"住址","Subitems":["北京","上海","广东","江苏","其他"],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"下拉选择框"},{"Key":"I_0","Sort":0,"Type":"radio","Category":"FIELD_WAGE","IsDefault":false,"Required":false,"Multiple":false,"Title":"月收入","Subitems":["少于3000","3000~5000","5000~10000","10000~20000","20000以上"],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"单选按钮框"},{"Key":"I_-1","Sort":-1,"Type":"textarea","Category":"FIELD_DESCRIPTION","IsDefault":false,"Required":false,"Multiple":false,"Title":"其他","Subitems":[],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"多行文本框"},{"Key":"I_0","Sort":0,"Type":"file","Category":"FIELD_ATTACHMENT","IsDefault":false,"Required":false,"Multiple":false,"Title":"附件","Subitems":["图片","word文档","ppt文档","pdf文档"],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"附件"}];
        var formEmptyItems = [{"Key":"I_0","Sort":0,"Type":"input","Category":"CUSTOM","IsDefault":false,"Required":false,"Multiple":false,"Title":"","Subitems":[],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"单行文本框"},{"Key":"I_0","Sort":0,"Type":"number","Category":"CUSTOM","IsDefault":false,"Required":false,"Multiple":false,"Title":"","Subitems":[],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"数字输入框"},{"Key":"I_0","Sort":0,"Type":"date","Category":"CUSTOM","IsDefault":false,"Required":false,"Multiple":false,"Title":"","Subitems":[],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"日期选择框"},{"Key":"I_0","Sort":0,"Type":"email","Category":"CUSTOM","IsDefault":false,"Required":false,"Multiple":false,"Title":"","Subitems":[],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"邮箱输入框"},{"Key":"I_0","Sort":0,"Type":"textarea","Category":"CUSTOM","IsDefault":false,"Required":false,"Multiple":false,"Title":"","Subitems":[],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"多行文本框"},{"Key":"I_0","Sort":0,"Type":"radio","Category":"CUSTOM","IsDefault":false,"Required":false,"Multiple":false,"Title":"","Subitems":[],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"单选按钮框"},{"Key":"I_0","Sort":0,"Type":"checkbox","Category":"CUSTOM","IsDefault":false,"Required":false,"Multiple":false,"Title":"","Subitems":[],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"多选按钮框"},{"Key":"I_0","Sort":0,"Type":"select","Category":"CUSTOM","IsDefault":false,"Required":false,"Multiple":false,"Title":"","Subitems":[],"Description":null,"IsHide":false,"Value":null,"TypeTitle":"下拉选择框"}];
            ...
            <tr class="event-create-ticket-config" id="edit_ticket_config{{SN}}">
                <td colspan="5">
                    <form action="/myevent/SaveEventTicket" id="event_ticket_form{{SN}}" method="post">						<input type="hidden" name="SN" value="{{SN}}"/>
                        ...
                        <input type="hidden" name="activityId" value="2354009652200" id="activityId{{SN}}"/>
    ...
    <script type="text/javascript">
        var eventTicketFreeJson = {"SN":-1,"Status":0,"Price":0,"Currency":null,"Title":"免费票","Description":null,"Quantity":0,"SoldNumber":0,"BookNumber":0,"BookStart":null,"BookEnd":null,"QuantityUnit":1,"MinOrder":1,"MaxOrder":1,"NeedApply":null,"EffectiveDate":null,"ExpiredDate":null,"Group":null,"Enabled":false,"BookPeriodStr":null,"EffectPeriodStr":null,"StatusStr":"报名尚未开始","OrderNums":[1],"IsSeriesTicket":false,"PriceStr":"免费","SrcPriceStr":null,"Discount":null,"Token":"1295FA024AF6CEF5974B5C51FE29166CF983D0E5041257046AC55F45C6CC4258AC49DFE099EBAE3EEE"};
        var eventTicketChargeJson = {"SN":-1,"Status":0,"Price":0.01,"Currency":null,"Title":"收费票","Description":null,"Quantity":0,"SoldNumber":0,"BookNumber":0,"BookStart":null,"BookEnd":null,"QuantityUnit":1,"MinOrder":1,"MaxOrder":3,"NeedApply":null,"EffectiveDate":null,"ExpiredDate":null,"Group":null,"Enabled":false,"BookPeriodStr":null,"EffectPeriodStr":null,"StatusStr":"售票尚未开始","OrderNums":[1,2,3],"IsSeriesTicket":false,"PriceStr":"¥0.01","SrcPriceStr":null,"Discount":null,"Token":"1295FA024AF6CEF5974B5C51FE29166CF95D7C7C2A2987FFAA52DA16EED9C184C0D9A9744DEA6F2ADA"};
        ...
        function refundSetting()
        {
            ...
            jQuery.ajax({
                ...
                type: "POST",
                data: { "id": '2354009652200', "RefundType": refundType, "RefundPrinciple": refundPrinciple},
                success: function(data) {
                    if (data != null && data.AjaxErrStatus != null && data.AjaxErrStatus == 1) {
    ...
    <div class="ft">
        <div class="container-lg">
            ...
            <center>
                ...
                <div>活动行 v3.9.4&nbsp;&copy; huodongxing.com All Rights Reserved. </div>
            </center>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="http://cdn.huodongxing.com/Content/v2.0/dist/js/libs.min.js?v=v3.9.4"></script>
...
<script type="text/javascript">
    function submitMySuggestion(){
        ...
        $.ajax({
            url: '/suggest',
            type: "POST",
            data: { "contact": sContactVal, "content": sContentVal, "token":"122B3F87C4D1ACF8D63EF73F86F01819F1647ED7DA34154457F4D479055BEEF2BAEDBDC4A585B08771" },
            success: function (data) {
